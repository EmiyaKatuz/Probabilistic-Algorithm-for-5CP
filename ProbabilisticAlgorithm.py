...
def Probabilistic(thres_d, thres_t, thres_p, weatherfile, actualdemandfile, forecastdemandfile):
    ...
    # Define parameters
    N = 31  # Number of days in the year from May 1st to September 30th
...
if __name__ == "__main__":
    Probabilistic(16635*0.99, -2, 0.55, 'weather.csv', 'ActualDemand202404with202504.csv', 'Forecastpeak_2025.csv')
